...
import hbuilder.android.com.presenter.BusinessSellDetailsPresenter;
import hbuilder.android.com.presenter.contract.BusinessSellDetailsContract;
...
public class BusinessSellDetailsFragment extends BaseFragment implements BusinessSellDetailsContract.View {
    ...
    protected void initView(View root) {
        tvTitle.setText("出售"+MyApplication.appContext.getResources().getString(R.string.inf));
    }
