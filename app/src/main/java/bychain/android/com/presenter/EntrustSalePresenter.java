...
import bychain.android.com.presenter.contract.EntrustSaleContract;
import bychain.android.com.presenter.modle.EntrustSaleModle;
...
public class EntrustSalePresenter implements EntrustSaleContract.Presenter{
    ...
    @Override
    public void putUpSell(double price, double minNum, double maxNum, boolean supporAli, boolean supportWechat, boolean supportBank, boolean supportCloud,boolean supportLakala,String financePwd, long time) {
        mView.showLoading();
        mModel.putUpSell(price,minNum,maxNum,supporAli,supportWechat,supportBank,supportCloud,supportLakala,financePwd,time).observeOn(AndroidSchedulers.mainThread())
