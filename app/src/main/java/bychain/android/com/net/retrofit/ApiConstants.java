package bychain.android.com.net.retrofit;
...
//        public static String getGetDomainNameBase = "https://d.xotc.fun/";//xotc测试环境
        public static String getGetDomainNameBase = "https://config.yy7777.fun/";//bychain线上环境
    ...
    public static final String DOWNLOADAPK = "ByChain.apk";//设置默认收款设置
